...
function Card(props) {
    return (
        <motion.div drag whileDrag={{ scale: 1.1 }} dragConstraints={props.reference} className=' relative w-[250px] mx-auto h-[250px] p-5 bg-zinc-200 rounded-2xl overflow-hidden'>
            <FaRegFileAlt />
